...
function getNodeScroll(node) {
    if (node === getWindow_getWindow(node) || !isHTMLElement(node)) return getWindowScroll(node);
...
function createTippy(reference, passedProps) {
    ...
    function onDocumentPress(event) {
        ...
        if (
            normalizeToArray(instance.props.triggerTarget || reference).some(function (el) {
    ...
    function onMouseMove(event) {
        ...
        var popperTreeData = getNestedPopperTree()
            ...
            .map(function (popper) {
                ...
                var state =
                    (_instance$popperInsta = instance.popperInstance) == null ? void 0 : _instance$popperInsta.state;
                if (state)
                    return {
